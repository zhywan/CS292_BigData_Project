/*
 * Recommender freelancer to project
 */
...
public class FreelancerRecommender {
	...
	public static void main(String[] args) {
		...
		String outputfilename = "data/Content_based_recommendation_result2.txt";
		...
		try {
			...
			//BufferedWriter PSfile = new BufferedWriter(new FileWriter("PS2.txt"));
			//BufferedWriter USfile = new BufferedWriter(new FileWriter("US2.txt"));
			int n_users=3900;
			...
			for (int i=0;i<project_id;i++){
				...
				//System.out.print("Project" + i + "(" + projectname[i] + "): ");
				outputfile.write("Project" + i + "(" + projectname[i] + "): ");
				for (int ii=0;ii<top;ii++){
					//System.out.print("user" + rec[ii] + "(" +username[rec[ii]] + ")[" + scores[ii] + "], ");
					outputfile.write("user" + rec[ii] + "(" +username[rec[ii]] + ")[" + scores[ii] + "], ");
				}
				//System.out.print("\n");
				outputfile.write("\n");
			}
